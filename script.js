document.addEventListener('DOMContentLoaded', () => {
    ...
    // New: Added logic to redirect PFE link to FDE.html
    const pfeLink = document.getElementById('pfeLink');
    pfeLink.addEventListener('click', (e) => {
        e.preventDefault();
        window.location.href = 'FDE.html';
    });
});
